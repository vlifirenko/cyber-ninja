...
namespace ToolExtensions
{
    ...
    public class RandomTransformer : EditorWindow
    {
        ...
        // Add menu item 
        [MenuItem("Tools/Productivity Toolkit/Random Transformer")]
        public static void ShowWindow()
        {
            RandomTransformer window = (RandomTransformer)GetWindow(typeof(RandomTransformer));
            window.titleContent = new GUIContent("Random Transformer");
            window.Show();
